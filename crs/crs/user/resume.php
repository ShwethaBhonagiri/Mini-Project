  ...
  <section>
    ...
    <div class="container" align="center">      
      <div class="row">
        <br><br><br>
        <div>
          <a href="resume-upload.php" class="btn btn-success" style="background-color: grey; border:2px solid black; border-radius: 5px; padding-left: 25px; padding-right: 25px; padding-top: 10px; padding-bottom: 13px; color: black; font-size: 20px; text-decoration: none;">Upload Resume</a>
        </div>
        <br><br>
        <?php
        ...
        if($result->num_rows > 0) {
          ...
          ?>
        <div>
          <a href="../uploads/resume/<?php echo $row['resume']; ?>" style="background-color: grey; border:2px solid black; border-radius: 5px; padding-left: 25px; padding-right: 25px; padding-top: 10px; padding-bottom: 13px; color: black; font-size: 20px; text-decoration: none;" download="Resume">Download Resume</a>
        </div>
        <?php } ?>
      </div>
    </div>
