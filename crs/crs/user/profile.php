        ...
        <div class="row">
          ...
          <div class="col-md-6">
              <div class="form-group">
                ...
                <input style="font-size: 20px; padding-left: 15px; padding-right: 15px; border: 1px solid black; border-radius: 5px; width: 100%; height: 40px; color: black; " type="tel" class="form-control" id="phone" name="phone" placeholder="1234-567-890" pattern="[0-9]{4}-[0-9]{3}-[0-9]{3}" required>
              </div>
              ...
              <div class="form-group" style="font-size: 20px; color: #053a5a;">
                <label for="dob">Date of Birth :</label>
                    <input style="font-size: 20px; padding-left: 15px; padding-right: 15px; border: 1px solid black; border-radius: 5px; width: 100%; height: 40px; color: black; " type="date" id="dob" name="dob"  value="2021-06-19" >
              </div>
              <div class="form-group" style="font-size: 20px; color: #053a5a;">
