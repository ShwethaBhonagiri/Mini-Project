      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="date" id="dob" name="dob" placeholder="Date of Birth *"  required="">
              </div>
          ...
          <div class="col-md-6">             
              ...
              <div class="form-group">
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="tel" id="phone" name="phone" placeholder="1234-567-890" pattern="[0-9]{4}-[0-9]{3}-[0-9]{3}" required>
              </div>
...
<div align="center" style="background-color: #053a5a; margin-top: -1.4%; height: 55px;">
  <a href="https://www.facebook.com/pages/CVR%20College%20of%20Engineering/103162473057212/"es target="_blank"><img src="img/facebook.png" style="width: 30px; height: 30px; margin-left: 5px; margin-right: 5px;" /></a>
