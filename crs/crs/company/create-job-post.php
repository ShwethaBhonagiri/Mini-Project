            ...
            <form method="post" action="addpost.php">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td style="font-size: 22px; color: #053a5a;">:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td><input style="font-size: 20px; padding-right: 15px; padding-left: 15px; padding-top: 5px; padding-bottom: 5px; border-radius: 5px; border: 1px solid #053a5a;" type="text" id="minimumsalary" name="minimumsalary" placeholder="eg: Rs.5,000" required=""></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="font-size: 22px; color: #053a5a;">:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td><input style="font-size: 20px; padding-right: 15px; padding-left: 15px; padding-top: 5px; padding-bottom: 5px; border-radius: 5px; border: 1px solid #053a5a;" type="text" id="maximumsalary" name="maximumsalary" placeholder="eg: Rs.10,000" required=""></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="font-size: 22px; color: #053a5a;">:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td><input style="font-size: 20px; padding-right: 15px; padding-left: 15px; padding-top: 5px; padding-bottom: 5px; border-radius: 5px; border: 1px solid #053a5a;" type="number" id="experience" name="experience" placeholder="Experience Required" required=""></td>
                </tr>
